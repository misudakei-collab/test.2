                ...
                <a href="{{ route('item.show', $item) }}" style="text-decoration: none; color: inherit; display: block;">
                    <div style="background: #fff; border: 1px solid #eee; border-radius: 4px; overflow: hidden; position: relative;">
                        ...
                        <div style="padding: 10px;">
                            <p style="margin: 0 0 5px 0; font-size: 0.95em; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ $item->name }}</p>
                            <p style="margin: 0; font-weight: bold; color: #111;">¥{{ number_format($item->price) }}</p>
                        </div>
                    </div>
                </a>
            @endforeach
