...
### 5. ユーザー管理
- **会員登録 / メール認証**：新規登録時に認証メールを送信し、不正な登録を防止
- **ログイン / ログアウト**：セッション管理による安全な認証状態の維持

### 6. 商品管理
- **商品の出品**：ドラッグ＆ドロップによる画像アップロード対応
- **商品の一覧・詳細表示**：出品された商品の情報を分かりやすくレイアウト
- **商品のお気に入り登録**：気になる商品をマイページに保存できる機能
